...
public class BD extends SQLiteOpenHelper {
    ...
    public void onCreate(SQLiteDatabase db) {
        db.execSQL("CREATE TABLE USUARIOS (IDUSUARIO INTEGER PRIMARY KEY AUTOINCREMENT, DNI TEXT, NOMBRE TEXT, APELLIDO TEXT, CONTRASEÑA TEXT, CORREO TEXT, SALDO DOUBLE)");
